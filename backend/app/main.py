...
from app.api import root_finding, differentiation, integration, interpolation, monte_carlo, ode, dynamic_1d, dynamic_2d
...
app.include_router(dynamic_2d.router)
